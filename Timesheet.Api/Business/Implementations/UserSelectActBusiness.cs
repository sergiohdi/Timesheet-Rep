...
namespace Timesheet.Api.Business.Implementations
{
    public class UserSelectActBusiness : IUserSelectActBusiness
    {
        ...
        public UserSelectActBusiness(IUserSelectActRepository userSelectActRepository)
        {
        ...
        {
            return _userSelectActRepository.GetUserPreferences(userId);
        }

        public void UpdateUserPreferences(UpdateTimesheetBasePropertiesRequest request, List<TimesheetItemDto> items) 
        {
