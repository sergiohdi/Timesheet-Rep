...
namespace Timesheet.Api.Repositories.Repositories.EF_Implementations
{
    public class ProjectRepository : IProjectRepository
    {
        ...
        public bool ValidateProjectsByClientId(int clientId)
        {
            return _db.Project.Any(x => x.ClientId == clientId);
        }
